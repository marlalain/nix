...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/marla/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/marla/bin" "/profile/bin" "/Users/marla/.npm-packages/bin" "/Users/marla/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
